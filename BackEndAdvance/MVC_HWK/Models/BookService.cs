...
namespace MVC_HWK.Models
{
    public class BookService
    {
        ...
        /// <returns></returns>
       public List<Models.BookData> GetBookDataByCondition(Models.BookSearchArg bookSearchArg)
        {
        ...
        public int UpdateBook(Models.BookData BookData)
        {
        ...
        /// </summary>
        /// <param name="BookId"></param>
        public List<Models.BookData> SearchBookById(string BookId)
        {
            DataTable dt = new DataTable();
            string sql = @"SELECT   dbo.BOOK_DATA.BOOK_STATUS, dbo.BOOK_DATA.BOOK_ID, dbo.BOOK_DATA.BOOK_NAME, 
                            dbo.BOOK_DATA.BOOK_CLASS_ID, dbo.BOOK_CLASS.BOOK_CLASS_NAME, dbo.BOOK_DATA.BOOK_AUTHOR, 
        ...
        {
            List<Models.BookData> BookResult = new List<BookData>();
            foreach (DataRow row in BookData.Rows)
            {
                BookResult.Add(new BookData()
                {
